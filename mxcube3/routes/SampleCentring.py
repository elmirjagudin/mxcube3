...
@mxcube.route("/mxcube/api/v0.1/sampleview/shape_result/<sid>", methods=['POST'])
def shape_result(sid):
    """
    Update grid result data.
        :parameter shape_data: dict with a list of results (cell number, score value)
